...
const ADAPTERS: Adapter[] = [
  ...
  { id: 'tally', name: 'Tally ERP', description: 'Ingests Daybook XML exports from Tally Prime / Tally.ERP 9 — the accounting backbone of 80% of Indian MSMEs. Maps vouchers to credit/debit transactions with party ledger counterparties.', icon: 'calculate', source: 'tally', type: 'ERP / Accounting', keysConfigured: true, requiredKeys: [] },
